...
(function(global) {
  ...
  Shapes.createRoad = function(attributes)
  {
    ...
    var ToString2 = road.toString();

    road.toString = function()
    {
      return '{' + ToString2 + ' | category : ' + attributes.category + '}';
    }
  ...
  Shapes.createBuilding = function(attributes)
  {
    ...
    var ToString2 = building.toString();

    building.toString = function()
    {
      return '{' + ToString2 + ' | area : ' + attributes.area + '}';
    }
  ...
  Shapes.createAmenity = function(attributes)
  {
    ...
    var ToString2 = amenity.toString();

    amenity.toString = function()
    {
      return '{' + ToString2 + ' | type : ' + attributes.type + '}';
    }
  ...
  Shapes.createNatural = function(attributes)
  {
    ...
    var ToString2 = natural.toString();
